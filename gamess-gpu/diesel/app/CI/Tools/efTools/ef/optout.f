...
C    .          20X,''G = '',F10.2)')ICYC,FUNCT/627.51,GN                       
      WRITE(7,'(2X,'' INTERNAL COORDINATE DUMP AT CYCLE '',I3)') ICYC           
      WRITE(6,'(/10X,''INTERNAL COORDINATES WRITTEN TO <intcoord>'')')          
      MODE=MODE1                                                                
      IF(MODE.EQ.1)THEN                                                         
         FLAG1=' *'                                                             
         FLAG0='  '                                                             
