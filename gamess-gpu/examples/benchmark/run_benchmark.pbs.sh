...
#PBS -o benchmark.pbs.log
#PBS -e benchmark.pbs.err
#PBS -N BENCH
...
MYPATH=$HOME/MFG/GAMESS-UK/examples/benchmark
MYDATA=$HOME/MFG/GAMESS-UK/examples/benchmark
WDPATH=/scratch/$USER/GAMESS-UK-benchmark
...
echo "Running benchmark examples."
date
