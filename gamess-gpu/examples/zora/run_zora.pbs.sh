...
MYPATH=$HOME/MFG/GAMESS-UK/examples/zora
MYDATA=$HOME/MFG/GAMESS-UK/examples/zora
WDPATH=/scratch/$USER/GAMESS-UK-zora

#
# Test jobs from ZORA Chapter of GAMESS Manual
#
date
...
joblist=$MYDATA/jobs.list.2

env

echo "Running zora examples."
date
...
$MYPATH/val_zora.sh -o
#
/bin/rm -rf mfged2 mfged3 ftn058
