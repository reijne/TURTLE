...
MYPATH=$HOME/MFG/GAMESS-UK/examples/chap3
MYDATA=$HOME/MFG/GAMESS-UK/examples/chap3
WDPATH=/scratch/$USER/GAMESS-UK-chap3

#
# Test jobs from Chapter 3 of GAMESS Manual
#
date
