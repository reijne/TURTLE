...
MYPATH=$HOME/MFG/GAMESS-UK/examples/chap7
MYDATA=$HOME/MFG/GAMESS-UK/examples/chap7
WDPATH=/scratch/$USER/GAMESS-UK-chap7

#
# Test jobs from Chapter 7 of GAMESS Manual
#
date
