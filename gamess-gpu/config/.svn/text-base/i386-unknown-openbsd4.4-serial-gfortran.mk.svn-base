...
#doc  on free BSD with the gfortran compiler
#doc
#doc  This is an experimental build  - the file is provided for developers
#doc  and others who wish to experiment with this platform
#doc 
#
# DEFAULT AND OPTIONAL OPTIONS
#dopt zora vb drf mrdci nbo vdw dl-find mopac sysmo O1
#opt demo debug static O0 O2
#
...
mainci.o:	mainci.m
	...
	$(FC) $(FFLAGSV) -fno-range-check $(OBJ_RENAME) $*.f
util5.o:	util5.m
