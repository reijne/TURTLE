...
#doc
#doc If using i8 ensure you remove the essl option unless you have an i8 essl library!
#doc
#doc Options:
...
#dopt mrdci nbo drf zora vb vdw sysmo dl-find 64bit essl 
#opt mopac debug datain i8
#
#
...
#--#if essl#
 For some unfathomable reason, the mclr case c2028_e fails when we use
