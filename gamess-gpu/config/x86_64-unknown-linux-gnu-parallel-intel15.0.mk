...
MACHINE_KEY=G
MACHOPT=linux,pclinux,littleendian,cio,unix,upck-equiv,xeon,helfey,sp0011
...
MPI_LIB=/cm/shared/apps/openmpi/intel/lib
...
#--#else# 
FFLAGSV  = ${FFLAGSTMP} -O3 -m64 -xAVX -mp1 -warn nousage -unroll -ip -ftz -mcmodel=medium -shared-intel
FFLAGSS  = ${FFLAGSTMP} -O2 -m64 -xAVX -mp1 -warn nousage -ip -ftz -mcmodel=medium -shared-intel
FFLAGSN  = ${FFLAGSTMP} -O1 -m64 -xAVX -mp1 -warn nousage -ip -ftz -mcmodel=medium -shared-intel
FFLAGSN0 = ${FFLAGSTMP} -O0 -m64 -xAVX -mp1 -warn nousage -ftz -mcmodel=medium -shared-intel
CFLAGS   = ${CFLAGSTMP} -mp1 -m64 -mcmodel=medium -xAVX -shared-intel
LDFLAGS  = ${LDFLAGSTMP} -mcmodel=medium -shared-intel
#--#endif#
...
#--#if i8#
# jmht - don't think this is actually needed, but have left it.
EXTRAI8= tst1s.o helfey.o gethes.o sp0011.o
EXTRA= $(EXTRAI8)
#--#else#
EXTRAI8=
