/*
 $Id: clustrf3.c,v 1.2 2000-10-26 15:38:19 psh Exp $
 *======================================================================
 *
 * DISCLAIMER
 *
...
*/
  ...
  *num_clustr = num_cls;
  ...
  for ( ii = 0; ii < 4* *num_clustr; ii++ )
    fprintf(stderr, "me = %d clustr_info[%d] =  %d \n", me, ii, *(c_ptr++));
  
  for ( ii = 0; ii < num_eig ; ii++ )
    fprintf(stderr, "me = %d mapZ[%d] =  %d \n", me, ii, mapZ[ii]);

  fprintf(stderr, "me = %d exiting clustrf2 imin =  %d \n", me, *imin);
