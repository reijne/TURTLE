/*
 $Id: clustrfix.c,v 1.3 2003-03-28 08:37:00 hvd Exp $
 *======================================================================
 *
 * DISCLAIMER
 *
       ...
       */
{
  ...
  *(c_ptr++) = bn;
  ...
  for ( iii = 0; iii < num_cls; iii++ ) {
    printf(" cptr c1 %d cn  %d b1 %d bn %d \n", (Integer)clustr_info[jjj++], (Integer)clustr_info[jjj++], (Integer)clustr_info[jjj++], (Integer)clustr_info[jjj++]);
  }
