...
c.....
         ...
         call gatsubx(2*(n2a+n2b),superg(0),ipos(n1+1),w(n1+1),
     1                nt-n1,val)
         value=(ddot(n1,g,1,w,1)+val)*dprod
c        call gatherx(2*(n2a+n2b),g(n1+1),superg(0),ipos(n1+1))
...
c.....
     ...
     &                     ((ifix.gt.nalfa).and.(isr.gt.ialfa)))
                  ...
                  call gatdotx(nt,superg(0),ipos,w,val)
                  value=val*dprod*ipar
c                 call gather(nt,g,superg,ipos)
c                 value =  ddot(nt,g,1,w,1) * dprod * ipar
c.....
               else if(ndelta.eq.2) then
c.....
