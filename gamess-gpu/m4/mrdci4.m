...
_ELSE
      common/scrtch/imat(67500),jmat(3780),f(mxcrec),
     *irm(mxcrec),h(100),ibal(8),itil(8),
     *mcomp(256),e(6633),c(400),nzer(256),
     *tc(255),rr(255),nfil(8),ndog(20),
_ENDIF
...
_IF1()      amanda=0.0
      ...
      scr1(mike)=tom
_IF1()      amanda=amanda+tom
 10   continue
_IF1()c     write (6,11) amanda
_IF1()c     write (6,12) (scr1(i),i=1,mike)
_IF1()c 11  format(10x,'net population is ',f15.8)
_IF1()c 12  format(5x,10f12.7)
      knu2=ideks(knu+1)
...
_IF1()      amanda=0.0
  ...
  32  ig=ig+1
_IF1()      amanda=amanda+scr1(ig)
      scr2(kate)=scr2(kate)+scr1(ig)
  30  continue
_IF1()c     write (6,40) (scr2(i),i=1,knu2)
_IF1()c 40  format(//5x,10f12.6)
_IF1()c     write (6,42) amanda
_IF1()c42   format(5x,'amanda 2',f15.8)
      return
      end
...
_ELSE
     *nj(8),ntil(8),nbal(9),ispa,ncomp(256),nzer(256),xdum(1300),
_ENDIF
...
_IF(notused)
       subroutine print_ifox(y,len1,iky,
     + iwod,vnuc,zero,imo,m,nconf,newya,
     + nytl,nplu,ndub,iswh,ksum,iorbs,
     + knu,cf,icf,c,ibal,itil,mcomp,kj,lj,n,
     + ifrk,e,lsym,nsel,nj,ntil,nbal,ncomp)
c
       implicit REAL  (a-h,o-z), integer (i-n)
c
INCLUDE(common/iofile)
c
       dimension nconf(5), newya(255), nytl(5),nplu(5),ndub(5)
       dimension cf(22500),icf(22500)
       dimension c(400), ibal(8),itil(8), mcomp(256)
       dimension kj(8), lj(8), e(6633), lsym(2040)
       dimension nj(8), ntil(8), nbal(9), ncomp(256)
       dimension y(len1), iky(*)
c
       dimension nzer(256), ilifs(256)
c
c      print first block of ifox
c
       write(iwr,*) 'iwod = ', iwod
       write(iwr,*) 'vnuc = ', vnuc
       write(iwr,*) 'zero= ', zero
       ...
       write(iwr,*) 'newya = ', (newya(loop),loop=1,iorbs)
c
       write(iwr,*) 'nytl = ',nytl
       write(iwr,*) 'nplu = ',nplu
       write(iwr,*) 'ndub = ',ndub
...
c
      write(iwr,9003)knu
 9003 format(/' no. of nuclei = ',i3)
       write(iwr,*) 'c array - znuc,   x,   y,   z'
       do loop = 1, knu
        write(iwr,*) c(loop), c(100+loop), c(200+loop), c(300+loop)
       enddo
c
       write(iwr,*) 'n = ', n
       write(iwr,*) 'ksum = ', ksum
       write(iwr,*) 'imo = ', imo
       icore = ksum - imo
       write(iwr,*) 'no. of frozen mos = ', icore
c
c
c
       write(iwr,*) 'ibal = ',ibal
...
c
       write(iwr,*) 'kj = ', kj
       write(iwr,*) 'number of active mos, lj = ', lj
       write(iwr,*) 'ifrk = ', ifrk
c
       write(iwr,*) 'e = ', e
       write(iwr,*) 'lsym = ', lsym
...
c
       write(iwr,*) 'ntil = ', ntil
       write(iwr,*) 'mcomp = ',(mcomp(loop), loop=1,iorbs)
       write(iwr,*) 'ncomp = ',(ncomp(loop), loop=1,iorbs)
      do i=1,n
      write(iwr,*) ' symmetry = ', i
      kp=kj(i)
      write(iwr,*) 'no. of active mos = ', kp
      lp=kp-lj(i)
      write(iwr,*) 'no. of active mos = ', lp
      kx=ntil(i)
      do j=1,kp
      write(iwr,*) 'm.o. ', j
      if(j.le.lp) then
