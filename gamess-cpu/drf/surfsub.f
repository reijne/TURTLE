...
c
      integer nrspts,nrc
c
      real*8 maxedge,minedge,pdens,scale,delta,sdis
      real*8 pi,one
c
...
c=============================================
c
cafc      parameter (maxinv=10,maxnrc=10000)
      parameter (maxnrc=10000)
c
c=============================================
c for the analrf routine
c=============================================
...
c
      dimension jvertex(3)
      real*8 normlen
      real*8 tedge(3),nm(3),rmt(3),rt1(3),rt2(3),rt3(3)
      real*8 bmina(3),cmina(3),bminc(3)
c
...
c
      integer surf(3,*),involv(maxinv,*)
      real*8 minedge,maxedge
      real*8 rs(3,*),rm(3,*),tnorm(3,*),area(*),norms(3,*),edge(3,*)
      logical lcni,lpla,lmid,luni,lmidout
c
c-----  declarations of local variables.
c
...
c-----  declarations of local variables.
c
      real*8 lmax,lrs,imp,lx,lt2,lt3,lt
      logical found
c
      character *8 errmsg(3)
c
