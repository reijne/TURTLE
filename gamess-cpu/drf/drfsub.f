...
c
c
      integer loc, ngauss, ns, ks
      common/defpar0/loc,ngauss,ns(maxat),ks(maxat)
c
      logical extra
      common/defpar1/extra
c
      real*8 ambel, elec, effchr, chargx, cords
      common /defpar2/ ambel,elec,effchr,chargx,cords(3)
c
      character*16 namei
      common /defpar3/ namei
c
...
c
      real*8 tim_not, tim0
      common /htimes/ tim_not(4),tim0
c
      real*8 sec0
      common /ztim/ sec0
c
      real*8 timlim, ti, tx, tim
...
c
      ...
      common /symstv/ ii,jj,lit,ljt,mini,minj,maxi,maxj,iandj
c
c
      real*8 s, g, ek
