...
*
      parameter (maxorb= 200, maxat=200)
      parameter (maxvar= 300, maxnz=200)
      parameter (mxshel= 600, mxprim=600, mxprms=50)
*
*   following parameters refer to analysis modules
*     mxgaus = maximum number of orbital primitives
*     mxgrps = maximum number of shells
      parameter ( mxgrps = 150, mxgaus = 1500)
*
