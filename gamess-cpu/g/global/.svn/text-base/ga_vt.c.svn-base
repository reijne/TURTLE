...
#ifdef EXT_INT
void vampir_begin_galinalg_(long *id, char *file, long *line)
{
    vampir_begin_galinalg((int)*id,file,(int)*line);
}

void vampir_end_galinalg_(long *id, char *file, long *line)
{
    vampir_end_galinalg((int)*id,file,(int)*line);
}
#else
