...
c     integer near_atom_list(num_near_atoms)
      real*8 rshell            ! the radius of the current batch
      real*8 rnear             ! distance of the closest atom to the
                             ! current atom
c
c     Output:
c
...
c
      ...
      real*8 rnear             ! distance of the closest atom to the
                             ! current atom
      real*8 ra2_val(mxp,natoms,2)    ! distance(point,atom)
      real*8 ra2_comp(mxp,natoms,3) ! x_point-x_atom
      real*8 arad(max_atom)    ! radii of the atoms
      real*8 xc_ept(mxp)       ! the value of the functional
c
c     Input/Output:
c
      real*8 wt(mxp)           ! on entry the atomic weights
                             ! on return the molecular weights
      real*8 hess(3*natoms,3*natoms) ! the hessian matrix
c
c     Output:
c
      real*8 dwt(3,mxp,num_near_atoms)
c     real*8 d2wt(mxp,3*num_near_atoms,3*num_near_atoms)
      logical dwt_avail_sw   ! true if gradients of the weights have
                             ! been calculated
c
c     Workspace:
...
C  *In/out variables                                                   *
      real*8 wt(npts)
C  *Work space                                                         *
      real*8 awt(npts), totwt(npts), sk(npts)
C  *Local variables                                                    *
      integer i,j,ipt,igrid,jgrid
      real*8 radi,radj,ratij,uij,aij,fk,diji
      real*8 uij1,fk1
      integer ipt1, ipt2
      real*8 uij2,fk2
C  *End declarations                                                   *
...
c
      ...
      common/dijtab/dij
      integer npts, mxp, natm
      real*8 ra2_val(mxp,natoms)
      real*8 ra2_comp(mxp,natoms,3)
      integer latm
      integer igrd
c
C  *In/out variables                                                   *
      real*8 wt(npts), gwt(3,mxp,natm)
C  *Work space                                                         *
      real*8 pa(npts), Z(npts), pk(npts)
      real*8 gpa(3,npts,natm),gZ(3,npts,natm)
      real*8 ti_ij(3,npts,natm), tj_ij(3,npts,natm)
C  *Local variables                                                    *
      ...
      integer ipt1, ipt2
      real*8 uij2,fk2
      real*8 dui_ijx,dui_ijy,dui_ijz
      real*8 duj_ijx,duj_ijy,duj_ijz
      real*8 vij,dvij,dfk,sk,dsk
C  *Functions                                                          *
c     real*8 srad
C  *End declarations                                                   *
C  *********************************************************************
...
c
      real*8 wt(npts)
      real*8 hess(nprt,nprt)
c
c...  Outputs
c
      real*8 gwt(3,mxp,natm)
c
c...  Workspace
c
      real*8 aij(natm,natm)
      real*8 uij(natm,natm)
      real*8 xij(3,natm,natm)
      real*8 rij(2,natm,natm) ! rij(i,*) stores dij**(-i)
      real*8 pk(natm)
      real*8 duijdi(3,natm,natm)
      real*8 duijdj(3,natm,natm)
      real*8 duijdk(3,natm,natm)
      real*8 d2uijdi2(3,3,natm,natm)
      real*8 d2uijdj2(3,3,natm,natm)
      real*8 d2uijdk2(3,3,natm,natm)
      real*8 d2uijdidj(3,3,natm,natm)
      real*8 d2uijdidk(3,3,natm,natm)
      real*8 d2uijdjdk(3,3,natm,natm)
      real*8 gZ(3,natm)
      real*8 g2Z(3*natm,3*natm)
      real*8 g2wt(3*natm,3*natm)
      real*8 dsijdi(3,natm,natm)
      real*8 dsijdj(3,natm,natm)
      real*8 dsijdk(3,natm,natm)
      real*8 d2sijdi2(3,3,natm,natm)
      real*8 d2sijdj2(3,3,natm,natm)
      real*8 d2sijdk2(3,3,natm,natm)
      real*8 d2sijdidj(3,3,natm,natm)
      real*8 d2sijdidk(3,3,natm,natm)
      real*8 d2sijdjdk(3,3,natm,natm)
c
c...  Local variables
c
      integer i, j, k, l, ipt
      ...
      integer igrid, jgrid
      real*8 radi, radj
      real*8 vij, f1ij, f2ij, f3ij
      real*8 df2ijdf1, df3ijdf2
      real*8 dvijdu, df1ijdv, df2ijdv, df3ijdv
      real*8 d2vijdu2, d2f1ijdv2, d2f2ijdv2, d2f3ijdv2
      real*8 sij
      real*8 dsijdu
      real*8 d2sijdu2
      real*8 tij
      real*8 tijk, tik, tjk
      real*8 tijl, til, tjl
      real*8 rix(3), rjx(3), ri, rj, ri1, rj1
      real*8 rijx(3), rij1, rij2
      real*8 Z
c
c...  Functions
c
...
c
C  *In/out variables                                                   *
      real*8 wt(npts), gwt(3,mxp,num_near)
C  *Work space                                                         *
      real*8 pa(npts), Z(npts), pk(npts)
      real*8 gpa(3,npts,num_near),gZ(3,npts,num_near)
      real*8 ti_ij(3,npts,num_near), tj_ij(3,npts,num_near)
C  *Local variables                                                    *
...
c
      ...
      real*8 ra2_val_g(mxp,natoms)
      real*8 ra2_comp_g(mxp,natoms,3)
      real*8 arad(natm)
      real*8 xc_ept(mxp)
      integer num_near_g
...
c...  Outputs
c
      real*8 gwt_g(3,mxp,num_near_g)
      logical gwt_avail_sw
c
c...  Workspace
c
      real*8 aij_g(num_near_g,num_near_g)
      real*8 xij_g(3,num_near_g,num_near_g)
      real*8 rij_g(2,num_near_g,num_near_g) ! rij(i,*) = dij**(-i)
      real*8 aij(num_near_g,num_near_g)
      real*8 xij(3,num_near_g,num_near_g)
      real*8 rij(2,num_near_g,num_near_g) ! rij(i,*) stores dij**(-i)
      real*8 uij(num_near_g,num_near_g)
      real*8 pk(num_near_g)
      real*8 ra2_val(num_near_g)
      real*8 ra2_comp(num_near_g,3)
      real*8 duijdi(3,num_near_g,num_near_g)
      real*8 duijdj(3,num_near_g,num_near_g)
      real*8 duijdk(3,num_near_g,num_near_g)
      real*8 d2uijdi2(3,3,num_near_g,num_near_g)
      real*8 d2uijdj2(3,3,num_near_g,num_near_g)
      real*8 d2uijdk2(3,3,num_near_g,num_near_g)
      real*8 d2uijdidj(3,3,num_near_g,num_near_g)
      real*8 d2uijdidk(3,3,num_near_g,num_near_g)
      real*8 d2uijdjdk(3,3,num_near_g,num_near_g)
      real*8 gZ(3,num_near_g)
      real*8 g2Z(3*num_near_g,3*num_near_g)
      real*8 gwt(3,num_near_g)
      real*8 g2wt(3*num_near_g,3*num_near_g)
      real*8 dsijdi(3,num_near_g,num_near_g)
      real*8 dsijdj(3,num_near_g,num_near_g)
      real*8 dsijdk(3,num_near_g,num_near_g)
      real*8 d2sijdi2(3,3,num_near_g,num_near_g)
      real*8 d2sijdj2(3,3,num_near_g,num_near_g)
      real*8 d2sijdk2(3,3,num_near_g,num_near_g)
      real*8 d2sijdidj(3,3,num_near_g,num_near_g)
      real*8 d2sijdidk(3,3,num_near_g,num_near_g)
      real*8 d2sijdjdk(3,3,num_near_g,num_near_g)
...
C *                                                                    *
      ...
      real*8 radi,radj,ratij,uij,uij2,uijm,aij,fk,diji
      integer mmax
      parameter (mmax=10)
      real*8 b(0:mmax)
C *                                                                    *
...
c
      real*8 gwt(3,mxp,natm)
c     real*8 g2wt(mxp,3*natm,3*natm)
c
c...  Workspace
c
      real*8 aij(natm,natm)
...
c
      ...
      integer igrid, jgrid
      real*8 radi, radj
      real*8 vij, vij2, vijm
      real*8 dvijdu, dfijdv, d2fijdv2
      real*8 d2vijdu2
      real*8 sij
      real*8 dsijdu
      real*8 d2sijdu2
...
c
      integer i,j,ipt,igrid,jgrid
      real*8 radi,radj,ratij,uij,fk,diji, aij
      real*8 a, uoa, uoa2, uoa3, uoa5, uoa7
c
      a = 0.60d0
c
...
c *                                                                    *
      integer i,j,ipt, igrid, jgrid
      real*8 radi,radj,ratij,uij,fk,diji, aij
      real*8 a, uoa, uoa2, uoa3, uoa4, uoa5, uoa6, uoa7
      real*8 vij, dvij, dfk, dsk, sk
      real*8 dui_ijx, dui_ijy, dui_ijz, duj_ijx, duj_ijy, duj_ijz
c
      a = 0.60d0
c
...
c
      ...
      integer ic, jc, kc
      integer igrid, jgrid
      real*8 vij, vij2, vij3, vij5, vij7
      real*8 fij, dfijdv, d2fijdv2
      real*8 dvijdu, d2vijdu2
      real*8 sij
      real*8 dsijdu
      real*8 d2sijdu2
      real*8 tij
...
c
      ...
      real*8 radi,radj,ratij,uij,fk,diji
      real*8 a, ainv, uoa, uoa2, uoa3, uoa5, uoa7, aij
c
c     End declarations
c     ***********************************************************
c
...
c *                                                                    *
      real*8 pa(npts), Z(npts), pk(npts)
      real*8 gpa(3,npts,num_near_atoms),gZ(3,npts,num_near_atoms)
      real*8 ti_ij(3,npts,num_near_atoms)
      real*8 tj_ij(3,npts,num_near_atoms)
      integer ibuff(npts)
c *                                                                    *
c *   Local variables                                                  *
c *                                                                    *
...
c
      ...
      real*8 radi,radj,ratij,uij,fk,diji
      real*8 a, ainv, uoa, uoa2, aij, b(0:4)
c
c     End declarations
c     ***********************************************************
c
...
c
      integer i,j,ipt, iat, jat, m, igrid, jgrid
      real*8 radi,radj,ratij,uij,fk,diji
      real*8 a, ainv, uoa, uoa2, aij, b(0:8)
c
c     end declarations
c     ***********************************************************
c
