...
#dopt zora vb drf mrdci nbo vdw dl-find sysmo O2
#opt demo debug static O0 O1  mopac
#
# ================ M4 Processing options
#
MACHINE_KEY=G
MACHOPT=linux,pclinux,littleendian,cio,unix,doublebackslash,upck-equiv,i8drct,GFS,glibc
