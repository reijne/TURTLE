...
#doc  on PA-RISC 2 processors and using the HP F90 v2.8.7 compiler.
#doc  Use the i8 keyword to switch from the default integer*4 build to integer*8
#doc  The veclib library is selected by default. This supports i8.
#
#dopt drf mrdci zora nbo vb mopac sysmo vdw dl-find veclib i8
#opt 
#
#
...
MACHINE_KEY=b
MACHOPT=hpux11,cio,unix,upck-equiv
...
BLASOPT=,blas,veclib
#--#if i8#
LIBBLAS = /opt/mlib/lib/pa20_64/libveclib8.a
#--#else#
LIBBLAS = /opt/mlib/lib/pa20_64/libveclib.a
#---#endif i8#
...
FFLAGSN0 = ${FFLAGSTMP} 
CFLAGS  = -c -Ae +DD64  -O ${CFLAGI8}
LDFLAGS =  +DD64  -lm +Ofast
#--#endif#
