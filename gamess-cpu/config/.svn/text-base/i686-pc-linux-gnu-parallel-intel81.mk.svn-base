...
#doc            mpich is expected in: /usr/local/Cluster-Apps/mpich-1.2.5..12-intel8
#
#
#dopt mp2 vb ga mpi i8 peigs vdw zora dl-find newscf
#opt mkl score mpiwrap goto
#
...
BLASOPT=,blas
#--#elseif goto#
LBLAS=-L/usr/lib -lgotoblas
BLASOPT=,blas
#--#endif#

#MPI and Global Array variables
...
MPI_LIBS=
#--#else#
MPI_INCLUDE = /usr/local/Cluster-Apps/mpich-1.2.5..12-intel8/include
MPI_LIB = /usr/local/Cluster-Apps/mpich-1.2.5..12-intel8/lib
LIBMPI= -lmpich
...
# MPICH Version:          1.2.6
# MPICH Release date:     $Date: 2007-10-10 12:56:24 $
