...
c.....no 8 -c1(kb,db)*h1(ib,db)*t(ib,kb)=-scr(ib,kb)*t(ib,kb)
            ...
            do 260 kb = 1 , nb
_IFN1(u)               z(8) = z(8)
_IFN1(u)     +            - ddot(nb,scr((kb-1)*nb+1),1,tb((kb-1)*nall+1),1)
_IF1(u)      call szero(qiof,maxqq)
...
c.....no 56 c1(mb,bb)*h1(mb,bb)
 ...
 340  continue
      call delfil(ifort3)
_IF1()c       write(iwr,*) ' end of big read loop '
...
_IF1()c     write(iwr,*) ' before call rasorn 5,6,9 '
...
_ENDIF
 ...
 940  continue
_IF()
c     h012 = z(88) + z(80) + z(81) + z(82) + z(83) + z(84) + z(85)
c    +       + z(86) + z(87)
c     write(iwr,*) ' h01 all alphas ',h012
c     h012 = z(188) + z(180) + z(181) + z(182) + z(183) + z(184)
c    +       + z(185) + z(186) + z(187)
c     write(iwr,*) ' h01 all betas ',h012
_ENDIF
      h013 = 0.0d0
      h014 = 0.0d0
      h015 = 0.0d0
 ...
 950  continue
_IF1()c      write(iwr,*) ' h01 abaa ',h013
_IF1()c     write(iwr,*) ' h01 aaab ',h014
_IF1()c     write(iwr,*) ' h01 abbb ',h015
_IF1()c     write(iwr,*) ' h01 bbab ',h016
      h017 = 0.0d0
      do 960 i = 1 , 49
         h017 = h017 + z(i)
         h01(3) = h01(3) + 4.0d0*z(i)
 960  continue
_IF1()c     write(iwr,*) ' h01 - all the rest ...... ',h017
     ...
     +         /(4*spin+6)
      ...
      f(2,2) = 1/(2*spin+2)
      f(1,1) = 1.0d0
_IF1()c     write(iwr,*) ' z so far '
_IF1()c     do 1039 jki=1,210
_IF1()c     write(iwr,*) ' jki,z ',jki,z(jki)
_IF1()c 1039   continue
_IF1()c     do  9999 iproj=1,3
_IF1()c     write (iwr,*) 'h00 ',(h00(i),i=1,iproj)
_IF1()c     write (iwr,*) 'h01 ',(h01(i),i=1,iproj)
_IF1()c     write (iwr,*) 's01 ',(s01(i),i=1,iproj)
_IF1()c     write (iwr,*) 's00 ',(s00(i),i=2,iproj+1)
_IF1()c 9999  continue
      write(iwr,6010)
      do 980 iproj = 1 , 3
         do 970 i = 1 , iproj
            ff(i) = f(iproj,i)
...
c     iaddr is address of (i,j) in transposed matrix
            iaddr = i + (ia(j)-1)*nov
            ibuck = (iaddr-1)/ninb
_IF1()c     write(iwr,*) ' ia(j),i,iaddr,nov,val ',
_IF1()c    +   j,ia(j),i,iaddr,nov,a(j)
            ia(j) = iaddr - ninb*ibuck
            ib(j) = ibuck + 1
_IF1()c     write(iwr,*) ' modified address - and bucket ',j,ia(j),ib(j)
 30      continue
c
         do 40 j = 1 , nrow
c
