...
c
      integer izint,idiag,igam,icivec,igrad,igam1,izint1
      common /mcaddr/ izint,idiag,igam,icivec,igrad,igam1,izint1
c
...
c.....form t(ext)
      ...
      call daxpy(ns2,(1.0d0/ dble(i)),q(iu),1,q(iv),1)
      call vclr(q(iu),1,ns2)
...
c.....form u(int)
      ...
      call daxpy(ni2,(1.0d0/ dble(i)),q(iu),1,q(iv),1)
      call vclr(q(iu),1,ni2)
...
280   format(i3,f20.7,e15.3)
      ...
      sparc =  dble(ispars-isparo)  /  dble(nc*(nvec-1))
      sparo =  dble(isparo)  /  dble(nrot*(nvec-1))
c
