...
c ...
      call vsmul(c,1,toang(1),cg80,1,natg3)
c ...
...
c ...
      ...
      dff  = dsqrt( ddot(natg3,cg80,1,cg80,1) / dble(natg3))
...
c
      call icopy(lenn,jmodf,1,ihc,1)
      else
c
c     ----- store the common -----
c
      call icopy(lenn,ihc,1,jmodf,1)
      endif
c
      return
      end
...
c
  ...
  100 continue
      ...
      implicit real*8  (a-h,o-z)
      integer*2 ip,jp,kp,lp,icp,igrp
...
c
      ...
      fdmax  = grdmax(n,fg)
      if ( ncalls .eq. 1 ) rms = dnrm2( n,fg,1)  / fnq
...
c
  300 continue
     ...
     +                ecn,dield,ndrv)
      implicit real*8  (a-h,o-z)
      integer*2 ip,jp,kp,lp,icp,no,iac
      logical dield
c
c
...
c
  ...
  100 continue
     ...
     +                  eel,dield,ntypes,ndrv)
      implicit real*8  (a-h,o-z)
      integer*2 ipres,iara,iarb,iac,ico,iblo,inb
      logical dield
c
      common/setbox/box(3),beta,boxh(3),boxhm,boxhm2,boxoh,boxoq,
     +              cosb,cosb2,ntm,ntb
...
c
     ...
     +                  x,igrp,cut,ntypes,gauss)
      implicit real*8  (a-h,o-z)
      integer*2 ico,iac,iblo,inb,iar1,iar2,igrp
...
c
      ...
      implicit real*8  (a-h,o-z)
      integer*2 ipres,igres,iara,iarb
      logical frozi,frozj
c
...
c
  ...
  100 continue
     ...
     +                  iar1,iar2,x,igres,cut,ntypes,igrp,gauss)
      implicit real*8  (a-h,o-z)
      integer*2 iar1,iar2,iac,ico,iblo,inb,ipres,igres,igrp,ifj
      logical*1 skip
