...
_ELSE
      logical *1 oijkl,oic,ojs,oks,ols
_ENDIF
...
13    idx=nfil(idx)
      ...
      if=nfg(idx)+1
_IF(cray)
      ijkl=shiftl(ic,24).or.shiftl(js,16).or.shiftl(ks,8).or.ls
_ELSEIF(ksr)
      ijkl=or(shiftl(ic,24),or(shiftl(js,16),
     *     or(shiftl(ks,8),ls)))
...
_IF(ibm,vax)
      dimension i205(340),j205(340),k205(340),l205(340)
      equivalence (i205(1),intin(1)),(j205(1),intin(341)),
     *            (k205(1),intin(681)),(l205(1),intin(1021))
_ENDIF
_IFN(cray,ksr)
      dimension icc(2)
...
720   call unpack(g(num2e+1),lab816,intin,numlab)
      int4=1
_ELSE
720   call upak8v(g(num2e+1),i205)
_ENDIF
      do 5 int=1,mword
_IF(ibm,vax)
      i=new(i205(int))
...
_IF(cray,ksr)
      ...
      jcc=ls+i4096(ks)
_IF(cray)
      ijkl=shiftl(icc,16).or.jcc
_ELSE
      ijkl=or(shiftl(icc,16),jcc)
_ENDIF
_ELSE
      icc(1)=js+i4096(ic)
      icc(2)=ls+i4096(ks)
...
c
  ...
  700 ntape=mtape
  702 do 2 i8=1,iq
_IFN1(c)      call setsto(2000,0,intin)
      ifm=ifm+imax
      irec=0
      ilc=0
   11 read (ntape) f
...
_IF(ibm,vax)
      dimension i205(340),j205(340),k205(340),l205(340)
      equivalence (i205(1),intin(1)),(j205(1),intin(341))
      equivalence (k205(1),intin(681)),(l205(1),intin(1021))
_ENDIF
...
_IF(ibm,vax)
     ...
     *  intout(1000)
      dimension intin(1360)
      equivalence (intin(1),i205(1))
_ELSE
...
_ENDIF
 ...
 710  call fget(gin,mmmm,num)
      ...
      if(mmmm)10,4,10
_IF(ibm,vax)
10    call upak8v(gin(num2e+1),i205)
_ELSE
