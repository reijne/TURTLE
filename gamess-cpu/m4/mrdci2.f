...
c
 ...
 32   if(lnklnk.ne.maxb)go to 33
   40 imc=imc+1
      lx=mmx
      kk=mmm
      call square(res,t(iwa+1),mjx,mjx)
      do 41 k=1,i
      mlim=k
      if(i.eq.k) mlim=j
      kk=kk+1
...
2     continue
      ...
      subroutine tmrd0(t,is,res,iorbs)
      implicit real*8 (a-h,o-z), integer (i-n)
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
      integer mxgrps, mxgaus, mxgrid, mxcalc, mxplot, mxrest
      integer mxstp,  maxlfn, maxfrt, maxbuf, maxblo, mxprms
...
c
     ...
     * kj(8),mcomp(256),ibal(8),itil(8)
     ...
     4kd,kr,inr,lp,kw,mmx,mmm,lx,kk,lw,mlim,mcp,ll,ld,lda,iw,iz,mc,mx,
     5ncp,kx,nrec2,ntel,irs,ijkl,nmel,ist,mi,jl,mk,ibl,jn,in1,in,ncas,
     6nlop,ia,ja,ka,la,kp,lenth,int,ii,icl,iorbss,llx,mjy,inb,i8,lly,ky,
...
40    lx=0
      imc=imc+1
      call square(res,t(iwa+1),iorbs,iorbs)
      do 41 ii=1,mjx
      mcp=mcomp(ii)
      call vclr(v,1,iorbs)
      do 43 i=1,mcp
...
2     continue
      ...
      subroutine tr1iii(ma,t,is,res,mjx)
      implicit real*8 (a-h,o-z), integer (i-n)
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
      integer mxgrps, mxgaus, mxgrid, mxcalc, mxplot, mxrest
      integer mxstp,  maxlfn, maxfrt, maxbuf, maxblo, mxprms
...
2     continue
      ...
      subroutine tr1iij(ma,mb,t,is,res,mjx)
      implicit real*8 (a-h,o-z), integer (i-n)
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
      integer mxgrps, mxgaus, mxgrid, mxcalc, mxplot, mxrest
      integer mxstp,  maxlfn, maxfrt, maxbuf, maxblo, mxprms
...
60    if(ii.eq.kk) go to 63
      go to 64
61    call tr1iii(ii,t(1),t(1),res,nj(ii))
      go to 59
62    call tr1iij(ii,kk,t(1),t(1),res,nj(ii))
      go to 59
...
111   if(i.eq.k) go to 114
      go to 115
112   call tr2iii(i,t(1),t(1),res,nj(i))
      go to 110
113   call tr2iij(i,k,t(1),t(1),res,nj(k))
      go to 110
