...
c
      ...
      integer*2 iv,jv,kv,iconve,iveca,ivecb
      character*1 xtyp
...
c
      ...
      real*8  a,d,e,e2,zero,h,scale,one,scale1,f,g,hh
...
c
      ...
      dimension          accxt(2)
      real*8  a,accxt,b,ul,x,res,dx,zero,xnorm,dxnorm
...
c
  ...
  660 continue
      ...
      mxx=ndeg(mx)
      factor=1.0d0
      if (selctc.eq.ssely.and.idega.eq.0) factor= dble(mxx)
      isuma=0
      do 680 k=1,kend
...
c
      implicit real*8  (a-h,o-z)
      integer*2 iv,jv,kv,iconve
      integer*2 itv,jtv,ktv
...
c
      implicit real*8  (a-h,o-z)
      integer*2 iv,jv,kv,iconve,ivecc
c
...
c
      implicit real*8  (a-h,o-z)
      integer*2 iv,jv,kv,iconve,itv,jtv,ktv
      character*1 xtyp,txtyp,ctemp
      character*8    selcta,selctb,xxsel,yysel,zzsel,sselx,ssely,selctc,
     *               selctd,sseld,ssele,tsele,word,bmvec,ztdaop
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
...
c
      implicit real*8  (a-h,o-z)
      integer*2 iv,jv,kv,iconve,iveca
      character*1 xtyp
      character*8    selcta,selctb,xxsel,yysel,zzsel,sselx,ssely,selctc,
     *               selctd,sseld,ssele,tsele,word,bmvec,ztdaop
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
...
c
      implicit real*8  (a-h,o-z)
      integer*2 iv,jv,kv,iconve,ivecb
      character*1 xtyp
      character*8    selcta,selctb,xxsel,yysel,zzsel,sselx,ssely,selctc,
     *               selctd,sseld,ssele,tsele,word,bmvec,ztdaop
      integer maxorb, maxat,  maxvar, maxnz,  mxshel, mxprim
