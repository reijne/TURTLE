...
c
      call pg_dgop(101,xs,l2,'+')
      call pg_dgop(102,ys,l2,'+')
      call pg_dgop(103,zs,l2,'+')
c
_ENDIF
      if(out) then
         write(iwr,9999)
...
c***   now gather them and send them to each other
c
      call pg_dgop(101,xxs,l2,'+')
      call pg_dgop(102,yys,l2,'+')
      call pg_dgop(103,zzs,l2,'+')
      call pg_dgop(101,xys,l2,'+')
      call pg_dgop(102,xzs,l2,'+')
      call pg_dgop(103,yzs,l2,'+')
c
_ENDIF
      if(out) then
         write(iwr,9999)
...
c
_IF(parallel)
c***   contributions to elfgr computed on each node
c***   now gather and sum
c
      call pg_dgop(101,elfgr,6*npt,'+')
c
_ENDIF
c
      return
...
c
_IF(parallel)
c***   contributions to elfld computed on each node
c***   now gather and sum
c
      call pg_dgop(101,elfld,3*npt,'+')
c
_ENDIF
c
      return
...
c
      ...
      out = out .and. oroot
      ono =.false.
_IFN1(cuiv)      call vfill(ten12,xyzmap,1,300)
_IF1(cu)      call setsto(300,ten12,xyzmap)
_IF1(iv)      call setstr(300,ten12,xyzmap)
c
c     ----- set pointers for partitioning of memory -----
c
      l1 = num
...
c
_IF(parallel)
c***   contributions to elpot computed on each node
c***   now gather and sum
c
      call pg_dgop(101,elpot,npt,'+')
c
_ENDIF
      return
      end
...
c
_IF(parallel)
c***   contributions to elden computed on each node
c***   now gather and sum
c
      call pg_dgop(101,elden,npt,'+')
c
_ENDIF
c
      return
...
c***   now gather them and send them to each other
c
      call pg_dgop(101,xxxs,l2,'+')
      call pg_dgop(102,yyys,l2,'+')
      call pg_dgop(103,zzzs,l2,'+')
      call pg_dgop(104,xxys,l2,'+')
      call pg_dgop(105,xxzs,l2,'+')
      call pg_dgop(106,yyxs,l2,'+')
      call pg_dgop(107,yyzs,l2,'+')
      call pg_dgop(108,zzxs,l2,'+')
      call pg_dgop(109,zzys,l2,'+')
      call pg_dgop(110,zzys,l2,'+')
c
_ENDIF
      if(out) then
         write(iwr,9999)
