...
c
c
      real*8 ex2, cs2, cp2, cd2, cf2, cg2
...
c
      ...
      call icopy(7*mxshel+4,kstart,1,kstrt2,1)
      normp1 = 0
      normf1 = 0
c
...
c
c
      complex*16 vect(2*l1,2*l1),dens(2*l1,2*l1)
      real*8 ener(2*l1)
c
      dimension q(*)
c
...
c
     ...
     +               ibl7so,ibl7o(8), ibl7la, ibl7ec, ibl7ha
c
      complex*16 vect,sb,scratch,alpha,beta
      real*8 s,q,tol,amreal,amimag,dia
c
...
c
  900 format(A,X,3(E10.4,X),/)
      ...
      real*8 function complex2real(sb,l1,j,i,mode)
c
      complex*16 sb(l1,l1)
      character*(*) mode
      integer l1,j,i
...
c**********************************************************************
c
      real*8 function etot_cs2(dens,fock,f_s,soaai,sobac,hF,q,l1)
c
...
c
      ...
      complex*16 fock,hF,sobac,ehf,zdotc,dens
...
c...  A is the matrix of eigenvectors, B is the eigenvalues, C is the output
      ...
      complex*16    A(l,l),C(l,l),zero,temp
