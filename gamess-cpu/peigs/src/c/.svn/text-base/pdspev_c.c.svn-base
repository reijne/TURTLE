/*
 $Id: pdspev_c.c,v 1.2 2000-10-26 15:38:24 psh Exp $
 *======================================================================
 *
 * DISCLAIMER
 *
 ...
 */
  ...
  */
  ...
  if ( linfo != 0 ){
    ...
    fprintf( stdout, " %s me = %d argument %d is a pointer to NULL. \n", msg, me, -linfo );
  ...
  */
  ...
  if ( *info != 0 ) {
      linfo = *info;
      fprintf( stdout, " %s me = %d argument %d has an illegal value. \n",
               msg, me, -linfo);
   ...
   */
   ...
   if ( *info != 0 ) {
       linfo = *info;
       fprintf( stdout, " %s me = %d argument %d contains a pointer to NULL. \n",
                msg, me, -linfo);
   ...
   */
   ...
   if ( *info != 0 ) {
       fprintf( stdout, " %s me = %d mapA,Z differ \n", msg, me );
   ...
   if ( linfo != 0 ) {
     *info = linfo;
     fprintf( stdout, " %s me = %d Insufficient workspace provided. \n", msg, me );
