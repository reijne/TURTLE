/*
 $Id: peigs_dlasq1a.c,v 1.2 2000-10-26 15:38:25 psh Exp $
*/
...
void peigs_dlasq1a( Integer n, DoublePrecision *dplus, DoublePrecision *lplus, DoublePrecision *eval, DoublePrecision *work, Integer *info)
{   
  Integer i, j, iii, me, nproc;
  DoublePrecision *dptr;
  extern void dlasq1a_();
  FILE *file;
  char filename[40];
  ...
  dlasq1a_( &n, &work[0], &work[n], &work[n+n], info );
