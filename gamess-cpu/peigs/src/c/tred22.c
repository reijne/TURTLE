/*
 $Id: tred22.c,v 1.3 2007-06-24 15:31:27 hvd Exp $
 *======================================================================
 *
 * DISCLAIMER
 *
                         ...
                         at least bufsiz bytes (see cmbbrf.h) */
{
  ...
  *iwork = *n;
  ...
  iscrat += *n + 1;
  peigs_pxerbla_( &k, (char *)iwork, mapA, n, iscrat, &linfo );
  if( linfo != 0 )
    linfo = -1;
  ...
  linfo = 0;
  k = *n * sizeof(Integer);
  peigs_pxerbla_( &k, (char *) mapQ, mapA, n, iscrat, &linfo );
