...
c    mit einem elementaren zyklus
      subroutine cycle2(kml,kmj,itranl,itranr,itrinc)
cvp
...
c   schleife ueber die verschiedenen spalten von umat2
cc      do 2150 kk2=1,kml
        do 2150 kk2=1,kmj
          do 2160 kk1=1,kml
            usp1(kk1)=umat2(kk1,kk2)
 2160     continue
          do 2170 kk1=1,kml
 ...
 2170     continue
          do 2180 kk1=1,kml
            ...
            if (lww.gt.kk1) then
              ...
              usp1(kk1)=usp1(kk1)+umat2(lww,kk2)*ausd2
              usp1(lww)=usp1(lww)+umat2(kk1,kk2)*ausd2
            endif
 2180     continue
          do 2190 kk1=1,kml
            umat2(kk1,kk2)=usp1(kk1)
 2190     continue
 2150   continue
 2140 continue
c
