...
MYPATH=$HOME/MFG/GAMESS-UK/examples/chap5
MYDATA=$HOME/MFG/GAMESS-UK/examples/chap5
WDPATH=/scratch/$USER/GAMESS-UK-chap5

#
# Test jobs from Chapter 5 of GAMESS Manual
#
date
