...
MYPATH=$HOME/MFG/GAMESS-UK/examples/chap6
MYDATA=$HOME/MFG/GAMESS-UK/examples/chap6
WDPATH=/scratch/$USER/GAMESS-UK-chap6
...
/bin/rm -rf ci.adapt vb.36 ci.tran gs.36

$MYPATH/val_chap6.sh -o
