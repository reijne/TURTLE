...
MYPATH=$HOME/MFG/GAMESS-UK/examples/chap4
MYDATA=$HOME/MFG/GAMESS-UK/examples/chap4
WDPATH=/scratch/$USER/GAMESS-UK-chap4

#
# Test jobs from Chapter 4 of GAMESS Manual
#
date
